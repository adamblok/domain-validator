 ...
 * version 2020102000, last updated tue oct 20 07:07:01 2020 utc
 */
...
var isDomainValid = function isDomainValid(domain, options) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if (label.length > 63) {
        return {
          result: false,
          message: "Label ".concat(label, " contains more than 63 characters")
        };
      }
      ...
      if (label.match(/[^a-zA-Z0-9\-]/)) {
        return {
          result: false,
          message: "Label ".concat(label, " contains a invalid character(s)")
        };
      }
      ...
      if (label.substr(0, 1) === '-') {
        return {
          result: false,
          message: "Label ".concat(label, " begins with hyphen")
        };
      }
      ...
      if (label.substr(-1) === '-') {
        return {
          result: false,
          message: "Label ".concat(label, " ends with hyphen")
        };
      }
      /**
       * IDN
      ...
      var checkConsecutiveHyphensFor = label;

      if (options.allowIdn) {
        var xnCount = (label.match(/xn--/g) || []).length;

        if (xnCount === 1) {
          if (label.indexOf('xn--') !== 0) {
            return {
              result: false,
              message: "Label ".concat(label, " contains xn-- pointer not at the very beginning")
            };
          }
          ...
          return {
            result: false,
            message: "Label ".concat(label, " contains more than one xn-- pointers")
          };
        }
      }
      ...
      if (checkConsecutiveHyphensFor.indexOf('--') !== -1) {
        return {
          result: false,
          message: "Label ".concat(label, " contains consecutive hyphens")
        };
      }
    }
    /**
  ...
  if (options.checkTld) {
    ...
    if (tldList.indexOf(tld) === -1) {
      return {
        result: false,
        message: "Tld ".concat(tld, " is not allowed")
      };
    }
  }
